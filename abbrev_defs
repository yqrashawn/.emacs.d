...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("mdoel" (\, "model") (\, nil) :count 0)
    ("mdoels" (\, "models") (\, nil) :count 0)
    ...
    ("permisson" "permission" nil :count 0)
    ("permissons" "permissions" nil :count 0)
...
(define-abbrev-table 'indium-list-scripts-mode-abbrev-table '())
