...
(use-package cc-mode
  ...
  (spacemacs|add-company-backends :backends (company-tabnine company-cmake) :modes cmake-mode :after-hook t)
  (when c-c++-enable-clang-support
    (spacemacs|add-company-backends :backends (company-tabnine company-clang)
                                    :modes c-mode-common
                                    :after-hook t)
...
(use-package company-c-headers
  ...
  :init (spacemacs|add-company-backends
          :backends (company-tabnine company-c-headers)
          :modes c-mode-common
          :after-hook t))
