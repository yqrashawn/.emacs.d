...
(use-package jest
  ...
  :init
  (push '("^\*jest.*<.*>$" :regexp t :dedicated t :stick t :position right :noselect t :kill t) popwin:special-display-config)
...
(defun +prettify-symbol-js ()
  (setq-local prettify-symbols-compose-predicate '+js2-prettify-symbols-default-compose-p)
  ...
  (push '("const" . ?Ċ) prettify-symbols-alist)
